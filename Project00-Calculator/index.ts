...
async function welcome() {
  ...
  welcomeMsg.stop();
  console.log(
    chalk.blueBright(` _____________________
|  _________________  |
| | JO           0. | |
| |_________________| |
|  ___ ___ ___   ___  |
...
async function getInput() {
  ...
  switch (val.operator) {
    case "Addition":
      console.log(
        chalk.blue(
          `${val.numOne} + ${val.numTwo} = ${val.numOne + val.numTwo} `
        )
      );
      break;
    ...
    case "Subtraction":
      console.log(
        chalk.magenta(`${val.numOne} - ${val.numTwo} = ${
          val.numOne - val.numTwo
        } `
      ));
      break;
    ...
    case "Multiplication":
      console.log(
        chalk.red(`${val.numOne} * ${val.numTwo} = ${val.numOne * val.numTwo} `)
      );
      break;
